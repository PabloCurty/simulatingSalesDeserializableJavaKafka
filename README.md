# simulatingSalesDeserializableJavaKafka
I simulated taking Sales Bytes in Kafka and deserializing using Java and Kafka, showing them on the console.  Project to simulate the production of mass messages using Java and Kafka. The goal is to see Kafka's behavior with a large flow of messages  Study design
